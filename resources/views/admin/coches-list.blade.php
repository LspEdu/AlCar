        ...
        <div class="row bg-white rounded justify-content-center shadow m-3 pb-2 ">
            <div class="col-11 m-1 text-center">
                ...
                <input x-model="buscar" id="buscador"
                    ...
                    placeholder="Busca por marca, modelo o matrícula">
            </div>
            <div class="col-11 col-md-3">
                <label class="mt-1 ms-1" for="tipo">
                    Tipo de coche
                </label>
                <select id="tipo" x-model="tipoCoche"
                    class="form-control mt-1 mb-2 p-1 border border-gray-400 rounded-md shadow">
            ...
            <div class="col-11 col-md-2">
                ...
                <select id="plazas" x-model="plazasCoche"
                    class=" form-control mt-1 mb-2 p-1 border border-gray-400 rounded-md shadow">
            ...
            <div class="col-11 col-md-3">
                ...
                <select id="combustible" x-model="combustibleCoche"
                    class="form-control mt-1 mb-2 p-1 border border-gray-400 rounded-md shadow">
                    <option value="">Cualquiera</option>
                ...
                <div class="col-11 card col-sm-5 col-lg-3 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text">
                            ...
                            <p>Estado <small x-show="coche.activo == true" class="text-success"
                                    x-text="'Activo'"></small>
