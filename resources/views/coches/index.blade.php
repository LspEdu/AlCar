    ...
    <div class="mt-4 mt-md-2 row gap-2 justify-content-around ms-1 me-1">
        ...
        <form class="col-12 col-md-4 bg-white rounded">
            ...
            <div class="row justify-around">
                ...
                <input id="precio" class="form-input col-6 text-right m-2 border-2  focus-outline-success rounded bg-slate-200 text-success fw-bolder fs-4" value=" {{$coche->precio}}€" readonly>
            </div>
        </form>
    </div>
